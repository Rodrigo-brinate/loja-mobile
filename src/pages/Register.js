...
setRedirect(<Redirect to={'/'} />)
  ...
  return (
    <View style={styles.container}>
       <Text style={{marginRight: 'auto',fontSize: 42,marginBottom: 20, marginLeft: 'auto'}}>register</Text>
       <View >{redirect}</View>
<TextInput style={styles.input} onChangeText={handleNameChange} placeholder="digite seu nome"/>
